...
public class NWayCacheThreadSafeWithLockImpl<K, V> implements NWayCache<K, V> {
    ReadWriteLock[] locks; // lock is kind of heavy. Maybe CAS is an improvement point. Unsafe is not available.
    ...
    public static void main(String[] args) {
        NWayCache<String, String> nWayCacheImpl = new NWayCacheThreadSafeWithLockImpl<String, String>(5, 2);
